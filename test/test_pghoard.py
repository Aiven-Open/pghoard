...
from pghoard.common import (
    TAR_METADATA_FILENAME, BackupReason, BaseBackupFormat, FileType, FileTypePrefixes, create_alert_file, delete_alert_file,
    write_json_file
)
...
dbname|"""
    ...
    def test_graceful_shutdown_with_timeout(self) -> None:
        self.pghoard.config["graceful_shutdown_queue_timeout"] = 1
        ...
        with patch.object(self.pghoard.log, "warning") as mock_warn:
            ...
            assert self.pghoard.compression_queue.qsize() != 0
            mock_warn.assert_any_call("Exceeded waiting time for %r queue to be emptied", "compression")
