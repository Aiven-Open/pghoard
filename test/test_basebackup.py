...
'''
    ...
    def test_basic_standalone_hot_backups_with_gnutaremu(self, capsys, db, pghoard, tmpdir):
        self._test_create_basebackup(capsys, db, pghoard, BaseBackupMode.basic, False, "standalone_hot_backup")
        self._test_restore_basebackup(db, pghoard, tmpdir, "standalone_hot_backup", tar_executable="pghoard/gnutaremu.py")
    ...
    def test_basic_gzip_standalone_hot_backups_with_gnutaremu(self, capsys, db, pghoard, tmpdir):
        self._test_create_basebackup(capsys, db, pghoard, BaseBackupMode.basic_gzip, False, "standalone_hot_backup")
        self._test_restore_basebackup(db, pghoard, tmpdir, "standalone_hot_backup", tar_executable="pghoard/gnutaremu.py")
    ...
    def test_basebackups_basic_with_gnutaremu(self, capsys, db, pghoard, tmpdir):
        self._test_basebackups(
            capsys, db, pghoard, tmpdir, BaseBackupMode.basic, restore_tar_executable="pghoard/gnutaremu.py"
        )
    ...
    def test_basebackups_basic_gzip_with_gnutaremu(self, capsys, db, pghoard, tmpdir):
        self._test_basebackups(
            capsys, db, pghoard, tmpdir, BaseBackupMode.basic_gzip, restore_tar_executable="pghoard/gnutaremu.py"
        )
